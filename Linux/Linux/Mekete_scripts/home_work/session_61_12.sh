...
echo "\nToday is" >> ~/research/sys_info.txt
date >> ~/research/sys_info.txt

echo "\nMake research directory" >> ~/research/sys_info.txt
mkdir ~/research 2> /dev/null >> ~/research/sys_info.txt
...
echo "\nTop 10 processes \n" >> ~/research/sys_info.txt
ps -aux | head -11 | awk '{print $1, $2, $4, $11}' >> ~/research/sys_info.txt

echo "export PATH=$PATH:~/Mekete_scripts" >> ~/.bashrc
